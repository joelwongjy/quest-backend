...
Contributions to backend include code, documentation, answering user questions,
and running the project's infrastructure.

This guide explains the process for contributing to this project's core `dsc-team-quest/backend` GitHub Repository and describes what to expect at each step.
...
6. In GitHub, send a merge request to `backend:master`
